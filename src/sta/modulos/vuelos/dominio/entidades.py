...
import sta.modulos.vuelos.dominio.objetos_valor as ov
from sta.modulos.vuelos.dominio.eventos import ReservaCreada, ReservaAprobada, ReservaCancelada, ReservaPagada
from sta.seedwork.dominio.entidades import Locacion, AgregacionRaiz, Entidad
