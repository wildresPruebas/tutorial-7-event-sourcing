...
from sta.modulos.vuelos.dominio.objetos_valor import NombreAero, Odo, Leg, Segmento, Itinerario, CodigoIATA
from sta.modulos.vuelos.dominio.entidades import Proveedor, Aeropuerto, Reserva
from sta.modulos.vuelos.dominio.eventos import ReservaAprobada, ReservaCancelada, ReservaAprobada, ReservaPagada, ReservaCreada, EventoReserva
